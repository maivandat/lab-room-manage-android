...
public class AppConstants {
    public static final String HOST_URL = "http://10.0.2.2/lab-room-manage/public/api/";
    ...
    public static final String BOOLEAN_REMEMBER = "BOOLEAN_REMEMBER";
    public static final boolean BOOLEAN_REMEMBER_DEFAULT = false;
    ...
    public static final String ID_BLOGIN = "ID_BLOGIN";
}
